...
namespace Emux.GameBoy.Cpu
{
    public static class Z80OpCodes
    {
        public static readonly Z80OpCode[] SingleByteOpCodes = 
        {
            ...
            new Z80OpCode("ld hl, sp+{0:x2}",     0xF8, 0x00, 1, 12, (d, i) => d.Cpu.Registers.HL = d.Cpu.Alu.Add(d.Cpu.Registers.HL, (ushort)(d.Cpu.Registers.SP + unchecked((sbyte)i.Operand8)), H | C, None, Z | N)),
